...
<Note>
`evaluation.adapters` lives at `python/evaluation/adapters` in the repo and is **not** part of the published `beeai-framework` package. To use it, clone the repo and run from within `python/` (e.g. via `poetry run`), or copy the adapter file(s) you need into your own project.
</Note>
