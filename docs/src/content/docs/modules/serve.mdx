...
| [Agent Stack](/integrations/agent-stack#exposing-to-the-platform-server)                     | `pip install beeai-framework[agentstack]` |
...
You can typically register one of the following:
