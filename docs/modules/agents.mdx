...
<Tip>
The Tool Calling Agent is available in both Python and TypeScript, but no longer actively supported. Use [RequirementAgent](/modules/agents/requirement-agent) instead.
</Tip>
