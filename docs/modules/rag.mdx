...
<Note>
Location within the framework: [beeai_framework/agents/experimental/rag](https://github.com/i-am-bee/beeai-framework/blob/main/python/beeai_framework/agents/experimental/rag).
</Note>
