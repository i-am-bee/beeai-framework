...
The BeeAI Framework core is designed to be extensible. Middleware leverages the underlying system of **Events** and **Run Contexts** to hook into the agent's lifecycle. Whether you need to log a thought process, sanitize an input, or halt a dangerous action, middleware provides the interface to inject that logic safely.
...
These useful abstractions allow you to:
