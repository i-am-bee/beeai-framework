...
<Note>
In this framework, "Middleware" refers to the classic software design pattern (pipeline interceptors). It is the code that runs between the agent's decision steps. This is distinct from the broader industry term "Agentic Middleware," which often refers to entire agent orchestration platforms.
</Note>
