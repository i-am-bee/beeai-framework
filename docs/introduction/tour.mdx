...
Use **Requirements** to guide how your agent thinks and acts. Let’s add the Think Tool and set up some conditional requirements to decide when tools should run.
