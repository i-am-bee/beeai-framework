...
<CardGroup cols={2}>
  <Card title="Foundation" icon="layer-group" href="#foundation%3A-build-your-first-agent">
    Your first simple chat agent using Agent and Backend modules
  </Card>
  
  <Card title="Intelligence" icon="brain" href="#intelligence%3A-add-capabilities">
    Add memory, tools, and templates for smarter agents
  </Card>
  
  <Card title="Knowledge" icon="book-open" href="#knowledge%3A-integrate-external-data">
    Ground your agent in data with RAG capabilities
  </Card>
  
  <Card title="Orchestration" icon="sitemap" href="#orchestration%3A-agent-coordination">
    Coordinate teams of specialized agents with Workflows
  </Card>
  
  <Card title="Production" icon="gears" href="#production%3A-scale-%26-monitor">
    Scale with caching, monitoring, and error handling
  </Card>
  
  <Card title="Integration" icon="server" href="#integration%3A-connect-%26-serve">
