...
| 🔧 [**Tools**](https://framework.beeai.dev/modules/tools)                 | Extend agents with built-in tools (web search, weather, code execution, Feedo decentralized memory, and more) or custom tools                                                                              |
