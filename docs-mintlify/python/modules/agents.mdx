...
> [!TIP]
> See the [tools documentation](/python/modules/tools.md) for more information on available tools and creating custom tools.
...
> [!TIP]
> See the [memory documentation](/python/modules/memory.md) for more information on memory types.
...
> [!TIP]
> See the [emitter documentation](/python/modules/emitter.md) for more information on event observation.

> [!TIP]
> See the [events documentation](/python/modules/events.md) for more information on standard emitter events.
...
> [!TIP]
> See the [workflows documentation](/python/modules/workflows.md) for more information.
