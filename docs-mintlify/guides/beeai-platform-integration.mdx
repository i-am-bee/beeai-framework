...
- [Implementing the agent](#implementing-the-agent)
...
- **BeeAI Framework extension for platform** installed with `pip install 'beeai-framework[beeai-platform]'`
- Project setup:
...
_Source: python/examples/agents/providers/beeai_platform.py_
