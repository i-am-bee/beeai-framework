...
async def main() -> None:
    ...
    for prompt in reader:
        await (
            workflow.run(
                inputs=[
                    AgentWorkflowInput(input="Provide a short history of the location.", backstory=prompt),
                    AgentWorkflowInput(
                        input="Provide a comprehensive weather summary for the location today.",
                    ...
                    AgentWorkflowInput(
                        input="Summarize the historical and weather data for the location.",
