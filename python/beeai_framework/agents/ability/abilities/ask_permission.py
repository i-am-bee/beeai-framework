...
class AskPermissionSchema(BaseModel):
    request: str = Field(
...
class AskPermissionAbility(Ability[AskPermissionSchema]):
    name = "ask_permission"
    ...
    @with_run_context
    async def run(self, input: AskPermissionSchema, context: RunContext) -> Any:
    ...
    @property
    def input_schema(self) -> type[AskPermissionSchema]:
        return AskPermissionSchema
