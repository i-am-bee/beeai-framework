...
class ReasoningAbility(AgentAbility[BaseModel]):
    name = "Reasoning"
    description = 'Use this tool when you want to think through a problem, clarify your assumptions, or break down complex steps before acting or responding. This is your internal "scratchpad" — a place to reason out loud in natural language.'
