...
class GlobalTrajectoryMiddleware(RunMiddlewareProtocol):
    ...
    def _bind_emitter(self, emitter: Emitter) -> None:
        ...
        @emitter.on(
            ...
            options=EmitterOptions(match_nested=False, is_blocking=True),
        )
        ...
        if self._match_nested:
            ...
            @emitter.on(
                ...
                options=EmitterOptions(match_nested=True, is_blocking=True),
            )
    ...
    def bind(self, ctx: RunContext) -> None:
        ...
        self._trace_level[ctx.run_id] = TraceLevel(relative=0, absolute=0)
        self._ctx = ctx
    ...
    def _log_trace_id(self, meta: EventMeta) -> None:
        ...
        if meta.trace.parent_run_id:
            ...
            parent_trace = self._trace_level.get(meta.trace.parent_run_id, TraceLevel(relative=0, absolute=0))
    ...
    def _get_trace_level(self, meta: EventMeta, *, type: Literal["self", "parent"] = "self") -> TraceLevel:
        ...
        return self._trace_level.get(run_id, TraceLevel(relative=0, absolute=0))
