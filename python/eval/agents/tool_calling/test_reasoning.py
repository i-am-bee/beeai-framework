...
from beeai_framework.tools.search import DuckDuckGoSearchTool, DuckDuckGoSearchToolInput
...
dataset = EvaluationDataset(
    test_cases=[
        LLMTestCase(
            input="I would like to spend the next weekend in Prague. Can you tell me something about the city and the weather forecast?",
            actual_output="",
            expected_tools=[
                tool_to_tool_call(
